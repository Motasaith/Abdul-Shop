  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-4xl mx-auto">
        <Link to="/admin/support" className="text-blue-600 hover:text-blue-800 flex items-center mb-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-gray-500 mt-1">Ticket #{ticket._id} • Created {new Date(ticket.createdAt).toLocaleString()}</p>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="border border-gray-300 rounded-md shadow-sm h-9 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
              >
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
          <div className="px-6 py-4 bg-gray-50 border-b border-gray-200">
            <h3 className="text-lg font-medium text-gray-900">User Query</h3>
          </div>
          <div className="p-6">
             <div className="flex items-start mb-6">
                ...
                <div className="ml-4">
                  ...
                  <div className="text-sm text-gray-500">{ticket.email} {ticket.phone && `• ${ticket.phone}`}</div>
                </div>
             </div>
        ...
        {ticket.response ? (
          <div className="bg-white rounded-lg shadow-sm overflow-hidden border-l-4 border-blue-500 mb-6">
            <div className="px-6 py-4 bg-blue-50 border-b border-blue-100">
              <h3 className="text-lg font-medium text-blue-900">Admin Response</h3>
              <p className="text-sm text-blue-700">Responded at {new Date(ticket.response.respondedAt).toLocaleString()}</p>
            </div>
            <div className="p-6">
              <p className="text-gray-800 whitespace-pre-wrap">{ticket.response.message}</p>
            </div>
          </div>
        ) : (
